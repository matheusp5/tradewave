...
export class GetAccountByUsernameUseCase
  implements
    IUseCase<
      IGetAccountByUsernameUseCaseRequest,
      Promise<IGetAccountByUsernameUseCaseResponse>
    >
{
  ...
  async execute({
    username
  }: IGetAccountByUsernameUseCaseRequest): Promise<IGetAccountByUsernameUseCaseResponse> {
